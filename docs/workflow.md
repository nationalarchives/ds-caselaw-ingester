...
sequenceDiagram
    ...
    loop for each Message
        ...
        Ingest ->> Ingest : Assign internal variables

        participant S3 as Amazon S3

        Ingest <<->> S3 : Download consignment .tar.gz

        Ingest ->> Ingest : Unpack .tar.gz
        ...
        note right of perform_ingest: This is where we actually start to insert or update things
